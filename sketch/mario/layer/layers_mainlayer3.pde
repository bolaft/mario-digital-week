...
//    addGround("ground", -32,height-48, width + 32,height);
    ...
    Koopa koopa = new Koopa(500, height-178);
    addInteractor(koopa);
    ...
    // key!
    //addForPlayerOnly(new KeyPickup(750,364));
  }
  ...
  void addTriggers() {
    ...
    addTrigger(new KoopaTrigger(1170,0,5,height, 350, height-64, -0.2, 0));
    addTrigger(new KoopaTrigger(1250,0,5,height, 350, height-64, -0.2, 0));
    addTrigger(new KoopaTrigger(1600,0,5,height, 350, height-64, -0.2, 0));
